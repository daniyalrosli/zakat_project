    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0a1e] via-[#1a1035] to-[#0d1a2d]">
      ...
      <main className="pt-16">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-8">
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white">District Statistics</h1>
            <p className="text-base text-gray-400 mt-2">Recipient distribution across {summaryStats.totalDistricts} districts in Kedah</p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/10 backdrop-blur-sm rounded-2xl p-5 border border-purple-500/20">
              <p className="text-sm text-purple-300 mb-1">Total Districts</p>
            ...
            <div className="bg-gradient-to-br from-cyan-500/20 to-cyan-600/10 backdrop-blur-sm rounded-2xl p-5 border border-cyan-500/20">
              <p className="text-sm text-cyan-300 mb-1">Total Recipients</p>
            ...
            <div className="bg-gradient-to-br from-pink-500/20 to-pink-600/10 backdrop-blur-sm rounded-2xl p-5 border border-pink-500/20">
              <p className="text-sm text-pink-300 mb-1">Largest District</p>
            ...
            <div className="bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 backdrop-blur-sm rounded-2xl p-5 border border-yellow-500/20">
              <p className="text-sm text-yellow-300 mb-1">Avg per District</p>
          ...
          <div className="grid lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 bg-[#1e1445]/60 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-base font-semibold text-white mb-1">Recipients by District</h3>
              <p className="text-sm text-gray-400 mb-6">Click on a bar to view details</p>
            ...
            <div className="bg-[#1e1445]/60 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-base font-semibold text-white mb-1">Distribution Share</h3>
              <p className="text-sm text-gray-400 mb-6">Top 6 districts</p>
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            {/* Age Distribution */}
            <div className="bg-[#1e1445]/60 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/20">
              <h3 className="text-base font-semibold text-white mb-1">Age Distribution</h3>
              <p className="text-sm text-gray-400 mb-6">Recipients by age group</p>
              <div className="space-y-3">
                {ageGroups.map((group, i) => (
                  <div key={i}>
                    <div className="flex justify-between mb-1">
                      <span className="text-sm font-medium text-gray-300">{group.range} years</span>
            ...
            <div className="bg-gradient-to-br from-purple-600/30 to-pink-600/20 backdrop-blur-sm rounded-2xl p-6 border border-purple-500/30">
              <h3 className="text-base font-semibold text-white mb-6">Demographic Insights</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-white/5 rounded-xl border border-purple-500/20">
                  <p className="text-sm text-gray-400 mb-1">Married</p>
              ...
              <div className="mt-4 p-4 bg-white/5 rounded-xl border border-purple-500/20">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-white">{summaryStats.averageAge} years</span>
                </div>
              </div>
            </div>
          </div>
